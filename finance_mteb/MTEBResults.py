...
from finance_mteb.abstasks.TaskMetadata import (
    ISO_LANGUAGE_SCRIPT,
    HFSubset,
)
from finance_mteb.languages import ISO_LANGUAGE, LanguageScripts
...
class MTEBResults(BaseModel):
    ...
    def _convert_from_before_v1_11_0(cls, data: dict) -> MTEBResults:
        from finance_mteb.overview import TASKS_REGISTRY
